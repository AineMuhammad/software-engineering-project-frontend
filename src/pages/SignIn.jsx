...
import { Google as GoogleIcon, Visibility, VisibilityOff, Email, Lock, TrendingUp, Psychology, LocalFlorist, Explore } from '@mui/icons-material';
import { motion } from 'framer-motion';
import { auth, googleProvider } from '../firebaseConfig';
import toast from 'react-hot-toast';
import { signinFetcher, setAuthToken } from '../utils/api';
...
const SignIn = () => {
  ...
  // SWR Mutation for signin
  const { trigger: signin, isMutating: loading } = useSWRMutation('/signin', signinFetcher);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Track your emotions, understand your patterns, transform your wellbeing
          </Typography>
      ...
      >
        ...
        >
          ...
          >
            {/* Mobile Logo */}
            <Box sx={{ display: { xs: 'flex', md: 'none' }, alignItems: 'center', mb: 2.5, justifyContent: 'center' }}>
